...
function getlocalStorage(data) {
    ...
    */
    ...
    cartButton.addEventListener("click", () => {
        	count = document.querySelector(".productPage__Container__Sub__Info__Amount__Container__Num");
		    ...
		    var currentColor = color__Value__Hex;
		    var currentSize = sizesSelect.innerHTML;
